#!/usr/bin/env python3
"""
Scrape CBS Sports to calculate WR receptions defensive rankings
"""
...
def scrape_team_wr_receptions_stats(team_abbr, max_week=None):
    """Scrape WR receptions allowed for a specific team through a certain week"""
...
def main():
    ...
    print("=" * 80)
    print("SCRAPING CBS SPORTS: WR Receptions")
    if max_week:
    ...
    for team_abbr, team_name in NFL_TEAMS.items():
        ...
        stats = scrape_team_wr_receptions_stats(team_abbr, max_week)
    ...
    if highlight_team:
        ...
        for team_data in team_stats:
            if team_data['team_abbr'] == highlight_team:
                ...
                print(f"Total WR Receptions Allowed: {team_data['total_receptions']}")
